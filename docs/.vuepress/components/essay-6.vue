  ...
  <div>
    ...
    <div class="essay-container">
      <div class="en">
        ...
        <p>They are in their TIME ZONE</p>
        <p>And you are in yours!</p>
        <p>Life is about waiting for the right moment to act</p>
        <p>So, RELAX</p>
        <p>You’re not LATE</p>
        <p>You’re not EARLY</p>
        <p>You are very much ON TIME</p>
        <p>And in your TIME ZONE Destiny set up for you</p>
      </div>
      <div class="zh">
        <p>纽约时间比加州时间早三个小时</p>
        <p>但加州时间并没有变慢</p>
...
.essay-bg {
  background: linear-gradient(to bottom right, rgba(255, 255, 255, 0.5), rgba(251, 215, 134, 0.75), rgba(247, 121, 125, 0.25)), url('/img/bg/essay-6.jpg') no-repeat bottom left;
